                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Declarer le total de commande livré par un livreur</h2>
...
<option value="">Select une franchise</option>
...
<div class="form-group">
                                                        <label for="date" class="col-sm-2 control-label ">Livreur</label>
                                                        <div class="col-sm-10">
...
<div class="form-group">
                                                        <label for="date" class="col-sm-2 control-label">Total livré</label>
                                                        <div class="col-sm-10">
                                                    <div  id="subject">
                                                    </div>
                                                        </div>
